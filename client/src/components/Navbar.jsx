  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      <div className="lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#f2f2f2] dark:bg-[#1c1c24] rounded-[100px] shadow-md">
        ...
        />
        <div className="w-[72px] h-full rounded-[20px] bg-[#1cba6b] flex justify-center items-center cursor-pointer shadow-md">
          <img
            src={search}
            alt="search"
      ...
      <div className="sm:flex hidden flex-row justify-end gap-4">
        <ConnectWallet
          className={
            "!font-epilogue !bg-[#1cba6b] !mr-5 !shadow-md !outline-none !font-semibold"
          }
          theme={
            (themeMode === "Light" &&
              lightTheme({
                colors: {
                  accentButtonBg: "#1cba6b",
                  primaryButtonBg: "#1cba6b",
                  accentText: "#1cba6b",
                },
              })) ||
            (themeMode === "Dark" &&
          ...
          welcomeScreen={{
            ...
            title:
              "Welcome To BlockFund: A Blockchain based CrowdFunding Application",
          }}
